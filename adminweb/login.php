        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="masuk.php" method="post">
              ...
              <div>
                <button class="btn btn-default submit" name="submit" value="Input" type="submit">Log in</buton>
              </div>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form action="regist.php" method="post">
              ...
              <div>
                <button class="btn btn-default submit" name="submit" value="Input" type="submit">Submit</button>
              </div>
